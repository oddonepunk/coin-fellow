...
use App\Services\Balances\BalanceService as BalanceServiceImplementation; 
...
use App\Services\Expenses\Interfaces\BalanceServiceInterface as ExpenseBalanceInterface;
...
class AuthServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(ExpenseBalanceInterface::class, BalanceService::class);
        $this->app->bind(BalanceServiceInterface::class, BalanceServiceImplementation::class); 
